...
public class EditLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Enter first name
		driver.findElement(By.xpath("(//div[@class='x-form-element']/input[@name='firstName'])[3]")).sendKeys("DivyaSimbhu");
		...
		driver.findElement(By.id("updateLeadForm_companyName")).sendKeys("Vina");
		//Clicking Update button
		driver.findElement(By.xpath("//td/input[@value='Update']")).click();
		//Confirm the changed name appears
		Thread.sleep(1000);
		String strName = driver.findElement(By.
				xpath("//div[@class='fieldgroup-title-bar']/following-sibling::div//tbody//td[2]/span[contains(text(),'Vina')]")).getText();
		System.out.println("Updated string "+strName);
		if(strName.contains("Vina")) {
